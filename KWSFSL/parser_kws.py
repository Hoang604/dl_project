...
#default values
default_model_name = 'repr_conv'
default_encoding = 'DSCNNL_LAYERNORM'
...
parser.add_argument('--model.x_dim', type=str, default='1,49,10', metavar='XDIM',
                    help="dimensionality of input images (default: '1,49,10')")
...
parser.add_argument('--model.z_dim', type=int, default=64, metavar='ZDIM',
                    help="dimensionality of output embeddings (default: 64)")
...
parser.add_argument('--model.z_norm', action='store_false', 
                    help="normalize feature vector (default: True)")
...
parser.add_argument('--model.patch_size', type=str, default='7,2', metavar='PATCHSIZE',
                    help="patch size for ViT encoder as comma-separated ints (default: '7,2')")
parser.add_argument('--model.num_heads', type=int, default=4, metavar='NUMHEADS',
                    help="number of attention heads for ViT (default: 4)")
parser.add_argument('--model.num_layers', type=int, default=4, metavar='NUMLAYERS',
                    help="number of transformer layers for ViT (default: 4)")
parser.add_argument('--model.dropout', type=float, default=0.1, metavar='DROPOUT',
                    help="dropout probability for ViT (default: 0.1)")


# train args - used for train
parser.add_argument('--train.epochs', type=int, default=40, metavar='NEPOCHS',
...
parser.add_argument('--train.n_episodes', type=int, default=400, 
                    help='train few shot learning: number of episodes  (default: 400)')
parser.add_argument('--train.n_way', type=int, default=80, 
                    help='train few shot learning: number of subclasses (default: 80)')
parser.add_argument('--train.n_support', type=int, default=0, 
                    help='train few shot learning: number of support samples (default: 0)')
parser.add_argument('--train.n_query', type=int, default=20, 
                    help='train few shot learning: number of query samples (default: 20)')
...
parser.add_argument('--train.loss', type=str, default='triplet',
                    help='Loss function to use (default: triplet)')
